[MapR-DB Shell](https://maprdocs.mapr.com/52/ReferenceGuide/mapr_dbshell.html) is a shell interface to interact with MapR-DB JSON. It is one of the best ways for developers to get started on MapR Platform.
